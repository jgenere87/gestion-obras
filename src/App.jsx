    ...
    <div className="app">
      ...
      <nav className="nav" aria-label="Secciones">
        {[["panel","Panel"],["nuevo","+ Reporte"],["reportes","Reportes"],["contratos","Contratos"],
          ["cubicaciones","Cubicaciones"],["oc","Órdenes de Cambio"],["bitacora","Bitácora"],["catalogo","Catálogo"]].map(([k,t]) => (
      ...
      <main className="main">
        ...
        {vista === "bitacora" && <Bitacora correo={sesion.user.email} perfil={perfil} />}
